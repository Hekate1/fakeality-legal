...
The best way to report a problem is from within the app, which lets us attach the diagnostic context we need to investigate. You can also email us at the address above with a description of what happened and, if possible, the date and time it occurred.

## Credits and purchases

Fakeality uses credits to generate scenes and episodes. Credit packs can be purchased in the app and are charged to your Apple Account.
...
Credits are non-refundable and have no cash value. All purchases and refunds are handled by Apple — to request a refund, visit [reportaproblem.apple.com](https://reportaproblem.apple.com).
